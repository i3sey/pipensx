...
SCREENS="${GOLDEN_SCREENS:-catalog detail frame downloads installed installed-populated settings settings-debrid help first-run debrid-link about torrent-selection bug-report bug-report-detail screenshot-viewer screenshot-viewer-preview screenshot-viewer-missing}"

...
SCREENS="${GOLDEN_SCREENS:-catalog detail frame downloads download-files deploy-preview installed installed-populated update-chooser settings settings-debrid storage help first-run debrid-link about torrent-selection bug-report bug-report-detail screenshot-viewer screenshot-viewer-preview screenshot-viewer-missing}"

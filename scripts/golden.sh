...
SCREENS="${GOLDEN_SCREENS:-catalog detail frame downloads installed settings settings-debrid about torrent-selection bug-report bug-report-detail screenshot-viewer screenshot-viewer-preview screenshot-viewer-missing}"
...
RU_SCREENS="${GOLDEN_RU_SCREENS:-frame catalog detail settings settings-debrid torrent-selection downloads}"
